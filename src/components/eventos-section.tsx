...
export function EventosSection() {
  const eventos = [
    {
      id: 1,
      title: "15 años",
      image: "/uploads/Tu-San-Agustin-Home_03.webp",
    },
    {
      id: 2,
      title: "Eventos empresariales",
      image: "/uploads/Tu-San-Agustin-Home_04.webp",
    },
    {
      id: 3,
      title: "Bodas",
      image: "/uploads/Tu-San-Agustin-Home_01.webp",
    },
  ]
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="relative mb-16">
          ...
          >
            ...
            className="w-full max-w-[340px] bg-white rounded-2xl border border-gray-300/60 shadow-md"
          >
          ...
          <Button className="btn btn-custom">
            ...
            <CarouselPrevious className="absolute left-4 top-1/2 -translate-y-1/2 bg-teal-500/80 hover:bg-teal-500 text-white border-none rounded-full w-10 h-10" />
            <CarouselNext className="absolute right-4 top-1/2 -translate-y-1/2 bg-teal-500/80 hover:bg-teal-500 text-white border-none rounded-full w-10 h-10" />
          </Carousel>
        </div>
 ...
 <div
  ...
  className=" --background
    ...
    before:w-screen before:border-t before:border-white/60
    after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2
    after:w-screen after:border-b after:border-white/60
  "
>
