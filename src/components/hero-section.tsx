...
export function HeroSection() {
  ...
  // We will store the embla API instance here
  ...
  useEffect(() => {
    ...
    const onSelect = () => {
      // selectedScrollSnap returns the index of the selected slide
              ...
              <div className="relative w-full h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] xl:h-[663.781px] max-w-[1905px] mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center text-center text-white pointer-events-none">
                  <div className="w-full max-w-4xl mx-auto px-4 sm:px-6">
                    <h1 className="text-4xl sm:text-3xl md:text-5xl lg:text-5xl mb-6 md:mb-8 " id="herotext"> 
                      {index === currentSlide ? slide.title : ""}
                    </h1>

                    <div className="mb-6 md:mb-8 flex justify-center">
                        <a href="https://api.whatsapp.com/send/?phone=573168753305&amp;text=Hola%21&amp;type=phone_number&amp;app_absent=0" class="btn btn-gold btn-lg shadow animate__animated animate__pulse animate__infinite mb-5">
